  ...
  function PaymentHide(){
    const isBuyed = productFilm.product_film_buyed === 'buyed';
    return(
      ...
      {/* <div onClick={() => createPayment({ ...productFilm, product_film_key: productFilm.product_film_key })} >
          <BaseBtn   BtnText="Купить" />
           ...
           <div onClick={!isBuyed ? () => createPayment({ ...productFilm, product_film_key: productFilm.product_film_key }) : null}>
          {/* Добавляем условие для отображения активности кнопки */}
          <BaseBtn BtnText="Купить" disabled={isBuyed} />
        </div>
