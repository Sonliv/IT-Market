...
If your project is configured for 8.+ Gradle, you may need to add the missing proguard rules after building.
You can copy them from the app -> build -> outputs -> mapping -> your_app_name -> missing_rules.txt file and add them to your proguard-rules.pro file.
